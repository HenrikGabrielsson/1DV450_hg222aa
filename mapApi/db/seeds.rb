...
Memory.create(title: "Birthday", memoryText: "Good times...", eventDate: Date.parse('31-10-2010'), longitude: 1.1, latitude: 2.12)
Memory.create(title: "Wedding", memoryText: "Good times...", eventDate: Date.parse('31-12-2010'), longitude: 1.1, latitude: 2.12)
Memory.create(title: "Funeral", memoryText: "Bad times...", eventDate: Date.parse('30-11-2010'), longitude: 1.1, latitude: 2.12)
